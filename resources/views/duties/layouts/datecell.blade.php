...
<div class="pure-u-1 pure-u-sm-1-2">
    ...
    <div class="pure-g">
        <div class="pure-u-13-24"><div class="input-box">
                <input type="text" name="{{ $id.$type }}-date" value="{{ $dt->format(config('dienstplan.date_format')) }}" class="date {{ $type }}-date" data-group="d{{ $id }}"/>
            </div></div>
        <div class="pure-u-11-24"><div class="input-box">
            <select name="{{ $id.$type }}-time" id="{{ $id.$type }}-time">
